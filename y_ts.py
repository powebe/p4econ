...
# Testing for non-normality
  ...
  _JB['JB-adj'] = df.DataFrame((sms.jarque_bera(model.resid)[0]/nobs*dof,scs.chi.cdf(sms.jarque_bera(model.resid)[0]/nobs*dof,2),sms.jarque_bera(u)[2],sms.jarque_bera(u)[3]))
  print('\n')
  print(_JB.round(4))
  print('\n\n')
  return model
